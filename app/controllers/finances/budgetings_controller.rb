class Finances::BudgetingsController < ApplicationController
 ...
 private
  ...
  def budget_params
    params.require(:budget).permit(:department_id, :office_id, :m_class_id, :year, :monthly_budget , monthly_budgets_attributes: [:name, :id, :month_number, :budget, :initial_budget, :additional_budget, :realization, :_destroy])
  end
