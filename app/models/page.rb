class Page < ActiveRecord::Base
  ...
  DASHBOARD = 'Dashboard'
  BRANCH = 'Setting - Cabang'
  UNIT = 'Setting - Satuan'
  HEAD_OFFICE = 'Setting - Head Office'
  USER = 'Setting - User Setting'
  HEAD_OFFICE_SETTING = 'Setting - Pengelolaan Head Office'
  BRANCH_SETTING = 'Setting - Pengelolaan Cabang'
  ...
  BANK = 'Master - Bank'
  GOODS_BRANCH_PRICE = 'Master - Setting Harga Cabang'
  MASTER_PAGES = [SUPPLIER, SIZE, TYPE, BRAND, COLOUR, MEMBER, BANK, GOODS_BRANCH_PRICE]

  GOODS_STOCK = 'Inventory - Stok Barang'
  EMPTY_STOCK = 'Inventory - Stok Kosong'
  ALL_BRANCHES_STOCK = 'Inventory - Stok Semua Cabang'
  GOODS_MOVEMENT = 'Inventory - Pindah Gudang di Cabang'
  GOODS_TRANSFER = 'Inventory - Transfer Antar Cabang'
  GOODS_AVAILABILITY = 'Inventory - Cek Ketersediaan Barang'
  ...
  PURCHASE_ORDER_MASTER = 'Pembelian - PO Gabungan'
  PURCHASE_ORDER = 'Pembelian - Purchase Order'
  VIEW_RETURN_TO_SUPPLIER = 'Pembelian - Retur Kepada Supplier (view)'
  CREATE_RETURN_TO_SUPPLIER = 'Pembelian - Retur Kepada Supplier (create)'
  VIEW_GOODS_ALLOCATION = 'Pembelian - Alokasi Barang Di Gudang (view)'
  CREATE_GOODS_ALLOCATION = 'Pembelian - Alokasi Barang Di Gudang (create)'
  GOODS_DISTRIBUTION_RECEIPT = 'Pembelian - Penerimaan Distribusi Barang'
  VIEW_GOODS_DISTRIBUTION = 'Pembelian - Distribusi Barang (view)'
  CREATE_GOODS_DISTRIBUTION = 'Pembelian - Distribusi Barang (create)'
  VIEW_GOODS_RECEIPT = 'Pembelian - Penerimaan Barang (view)'
  CREATE_GOODS_RECEIPT = 'Pembelian - Penerimaan Barang (create)'
  INSPECT_GOODS_RECEIPT = 'Pembelian - Penerimaan Barang (Inspeksi)'
  VIEW_RETURN_TO_HO = "Pembelian - Retur Kepada HO (view)"
  CREATE_RETURN_TO_HO = "Pembelian - Retur Kepada HO (create)"
  RETURN_TO_HO_RECEIPT = "Pembelian - Penerimaan Retur to HO"
  ...
  POS = 'Penjualan - Penjualan Dari POS'
  EXCHANGE = 'Penjualan - Penukaran'
  CREATE_GOODS_REQUEST = 'Penjualan - Permintaan Turun Barang (create)'
  VIEW_GOODS_REQUEST = 'Penjualan - Permintaan Turun Barang (view)'
  SALE_PAGES = [POS, EXCHANGE, CREATE_GOODS_REQUEST, VIEW_GOODS_REQUEST]

  STOCK_REPORT = 'Report - Laporan Stock'
  SALES_REPORT = 'Report - Laporan Penjualan'
