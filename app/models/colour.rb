...
#  include Filter
  ...
  validates :name, :presence => {message: 'harus diisi'} , :uniqueness => true
  validates_format_of :name, :with => /^[a-zA-Z\d\s]*$/i, :multiline => true, :message => "hanya mengijinkan input alphabet"
