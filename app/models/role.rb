...
#[[1, "CEO"], [2, "Manager"], [3, "Head Admin"], [4, "Inventory"], [5, "Purchase"], [6, "Finance"], [7, "Admin Inventory"], [8, "Admin Purchase"], [9, "Admin Finance"], [10, "Kasir"], [11, "Gudang"], [12, "SPG"], [13, "Member"], [14, "Supplier"]]
  ...
  def generate_accessable_pages
    ...
    view_features = view_inventory + view_purchase + view_finance + ['View Supplier', 'View Brand', 'View Colour', 'View Size', 'View Department', 'View M-Class', 'View Member',
    ...
    if id == CEO
      (view_full_features + manage_inventory + manage_purchase + manage_finance + ['Manage Supplier', 'Manage Brand', 'Manage Colour', 'Manage Size', 'Manage Department',
