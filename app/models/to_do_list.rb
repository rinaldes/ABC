class ToDoList < ActiveRecord::Base
  ...
  validates :date, :presence => {:message => 'harus diisi'}
  validates :end_at, :presence => {:message => 'harus diisi'}
  ...
  mount_uploader :image, ImageUploader
	...
	def has_branches
		errors.add(:base, 'Tujuan harus pilih salah satu atau lebih') if self.branch_to_do_lists.blank?
	end
  ...
  def self.import(file)
    ...
    return "ToDoList Successfully imported"
  end
